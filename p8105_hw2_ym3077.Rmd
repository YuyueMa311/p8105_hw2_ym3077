...
prof_trash <- read_excel("Trash-Wheel-Collection-Totals-2020-2023.xlsx",
...
# Read and clean Gwynnda
gwynnda <- read_excel("Trash-Wheel-Collection-Totals-2020-2023.xlsx",
                      sheet = "Gwynnda the Good Wheel of the West",
                      skip = 1) |> 
  janitor::clean_names() |> 
  filter(!is.na(dumpster)) |> 
  mutate(
...
trash_wheel_data <- bind_rows(mr_trash, prof_trash, gwynnda)
```
