...
and 15 variables, where each row represents the rental price index
...
distinct classification methods: `county_name` from the original Zillow
...
`zip_missing` dataset consist of 171 ZIP codes that appear in the ZIP
code dataset but not in the Zillow Rental Price dataset. For example,
ZIP codes such as 10475, 11245, or 10082 appear in `zipcode_clean` but
not in `zillow_long`, it suggests that Zillow did not report or collect
rental price information for these areas. Possible reasons are areas
with very few rental listings, Zillow might suppress data to protect
individual privacy or due to insufficient sample size; or some ZIP codes
may be primarily industrial/commercial, with have low residential rental
activity, making difficult for Zillow to estimate or report rental
prices.
...
```
    ...
    ## # A tibble: 10 × 6
    ##    zip   borough  neighborhood  `rent_2020-01-31` `rent_2021-01-31` price_change
    ##    <chr> <chr>    <chr>                     <dbl>             <dbl>        <dbl>
    ##  1 10007 New York Lower Manhat…             6334.             5422.        -913.
    ##  2 10069 New York <NA>                      4623.             3875.        -748.
    ##  3 10009 New York Lower East S…             3406.             2692.        -714.
    ##  4 10016 New York Gramercy Par…             3731.             3019.        -712.
    ##  5 10001 New York Chelsea and …             4108.             3398.        -710.
    ##  6 10002 New York Lower East S…             3645.             2935.        -710.
    ##  7 10004 New York Lower Manhat…             3150.             2444.        -706.
    ##  8 10038 New York Lower Manhat…             3573.             2876.        -698.
    ##  9 10012 New York Greenwich Vi…             3629.             2942.        -686.
    ## 10 10010 New York Gramercy Par…             3697.             3012.        -685.

The table shows the 10 ZIP codes in New York City that experienced the
largest drops in rental prices between January 2020 and January 2021,
